...
#ifndef _MSRCARTPROV_HPP_
#define _MSRCARTPROV_HPP_
#if __WXMSW__
...
class wxMicrosoftResourceArtProvider: public wxArtProvider
{
public:
	wxMicrosoftResourceArtProvider();
